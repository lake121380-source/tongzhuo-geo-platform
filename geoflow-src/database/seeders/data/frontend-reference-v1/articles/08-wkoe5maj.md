桐灼GEO AI 知识库是系统的事实与召回基础，用于把业务资料转成可检索、可追踪的知识资产，并在文章生成时提供证据上下文。

## 知识库的定位与能力

在 桐灼GEO 中，知识库是事实与召回层，它将文档、网页与团队经验沉淀为可检索、可引用、可治理的知识资产。生成任务时，混合召回将匹配证据注入提示词，让输出贴近资料并支持引用来源。知识库聚焦五类问题：资料沉淀、证据召回、事实约束、治理能力与可引用性。
