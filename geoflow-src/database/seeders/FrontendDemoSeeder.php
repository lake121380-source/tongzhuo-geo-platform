...
class FrontendDemoSeeder extends Seeder
{
    ...
    {
        $settings = [
            'site_name' => '桐灼GEO Support',
            'site_title' => '桐灼GEO Support',
            'site_subtitle' => '像 Apple Support 一样组织你的内容知识库',
            'site_description' => '用于预览 桐灼GEO 前台模板的示例内容站，覆盖首页、分类列表页和文章详情页。',
            'site_keywords' => '桐灼GEO,Apple Support,帮助中心,内容知识库,GEO优化',
            'copyright_info' => '© '.date('Y').' 桐灼GEO Support Demo. All rights reserved.',
            'site_logo' => '',
            'site_favicon' => '',
            'analytics_code' => '',
    ...
    private function seedCategories(): array
    {
        $rows = [
            ...
            [
                ...
                'name' => 'AI 内容工作流',
                'description' => '展示 桐灼GEO 如何组织选题、生成、审核和发布 AI 内容。',
                'sort_order' => 30,
            ],
            [
                'slug' => 'geo-growth',
