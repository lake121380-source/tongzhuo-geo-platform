...
class AdminUserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($exists) {
            $this->command?->info('桐灼GEO default admin already exists; seeding skipped without overwriting credentials.');
        ...
        if ($password === '') {
            if (app()->environment('production')) {
                ...
                $this->command?->warn('桐灼GEO created default admin ['.$username.'] with a one-time generated password: '.$password);
