...
/**
 * 桐灼GEO 业务相关配置（站点信息、后台路径、上传、缓存、会话与安全）。
 *
...
return [
    ...
    // 站点展示名称（页眉、标题等）
    'site_name' => env('SITE_NAME', '桐灼GEO'),
    // 站点完整/副标题文案
    'site_full_name' => env('SITE_FULL_NAME', '桐灼GEO'),
    ...
    // 后台系统更新中心由独立 桐灼GEO Updater 执行变更，应用仅保留状态、操作桥接和只读旧记录。
