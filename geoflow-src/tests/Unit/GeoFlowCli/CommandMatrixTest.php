...
class CommandMatrixTest extends TestCase
{
    ...
    #[Test]
    public function public_contract_keeps_38_operations_on_36_routes(): void
    {
        $this->assertCount(38, self::contracts());
        $this->assertCount(38, OperationRegistry::all());
    ...
    private static function contracts(): array
    {
        return [
            ...
            'material.knowledge-search' => self::contract(
                ['material', 'search', '9', '--query', 'GEO 服务'],
                'GET',
                'materials/knowledge-bases/9/search?query=GEO%20%E6%9C%8D%E5%8A%A1&limit=8&max_chars=6000',
            ),
