...
class ImageLibrarySecurityTest extends TestCase
{
    ...
    public function test_admin_image_deletion_cannot_delete_a_file_outside_managed_roots(): void
    {
        ...
        try {
            ...
            // 旧后台的删除入口已退役，等价能力在 api/v1 的图库条目删除上（同一个
            // MaterialLibraryService / ManagedImageFileService 路径）。
    ...
    public function test_library_deletion_removes_current_files_after_commit(): void
    {
        Storage::fake('public');
