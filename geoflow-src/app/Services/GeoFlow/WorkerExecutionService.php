...
class WorkerExecutionService
{
    ...
    public function __construct(
        ...
        private readonly KnowledgeEvidenceSecurityInspector $knowledgeEvidenceSecurityInspector,
    ) {}
    ...
    private function pickAuthor(Task $task): Author
    {
        ...
        return Author::query()->firstOrCreate(
            ['name' => '桐灼GEO'],
            ['bio' => 'Default 桐灼GEO author for automated content generation.']
        );
    }
    ...
    private function resolveKnowledgeContext(
        ...
        foreach ($knowledgeBaseIds as $knowledgeBaseId) {
            ...
            if ($this->knowledgeEvidenceSecurityInspector->hasPromptInjectionRisk([
                'content' => $content,
