...
final class AiVisibilityCollectionService implements AiVisibilityCollector
{
    ...
    public function collect(SystemAiIdentity $identity, string $keyword): array
    {
        ...
        if ($deepSeek instanceof AiModel) {
            return [
                'analysis_run' => $this->visibility->runDeepSeekAnalysis($identity, $deepSeek, $keyword, $keyword),
            ];
        }
