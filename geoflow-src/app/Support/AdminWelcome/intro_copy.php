...
return [
    'zh-CN' => [
        'meta' => [
            ...
            'close' => '关闭',
            'links_label' => '继续了解 桐灼GEO 3.0，可以查看更新日志、项目仓库和作者主页。',
            'author_link' => '作者 X 主页',
            'github_link' => '项目 GitHub',
            'changelog_link' => '更新日志',
        ],
        'letter' => [
            'title' => '欢迎使用 桐灼GEO 3.0',
            'subtitle' => '桐灼GEO 是一套面向企业官网、行业信源平台和内部内容运营的开源 GEO 智能运营系统。它围绕可信知识、内容生产、质量审核、多站分发和数据反馈，建立一条可持续运营的工作链路。',
            'blocks' => [
                [
                    'type' => 'paragraph',
                    'content' => '你好，欢迎来到 桐灼GEO 3.0。这个主版本重新统一了后台体验，也把知识、AI、审核、发布、分发、人工运营与数据分析接成了一套完整的 GEO 运营工作台。',
                ],
                [
                    'type' => 'paragraph',
                ...
                [
                    ...
                    'items' => [
                        ...
                        '多端运营链路：支持本站、托管渠道站点、桐灼GEO Agent、WordPress、通用 API 和 Chrome 运营助手',
                        '可追踪的工程保障：通过任务与队列状态、分发日志、AI 可见性、访问分析，以及独立更新、完整备份和回滚能力管理运行风险',
                    ],
                ],
                [
                    'type' => 'heading',
                    'content' => '桐灼GEO 可以用在哪里',
                ],
                [
                    'type' => 'list',
                    'items' => [
                ...
                [
                    'type' => 'list',
                    'items' => [
                        '桐灼GEO 用于提高内容工程效率，以及内容被 AI 理解、引用和推荐的概率；平台排名与展示结果仍由各答案引擎决定',
    ...
    'en' => [
        'meta' => [
            ...
            'switch_label' => '中文',
            'close' => 'Close',
            'links_label' => 'To learn more about 桐灼GEO 3.0, visit the changelog, project repository, or author profile.',
            'author_link' => 'Author X Profile',
            'github_link' => 'Project GitHub',
            'changelog_link' => 'Changelog',
        ],
        'letter' => [
            'title' => 'Welcome to 桐灼GEO 3.0',
            'subtitle' => '桐灼GEO is an open-source GEO operations system for corporate websites, vertical source platforms, and internal content operations. It connects trusted knowledge, content production, quality review, multi-site distribution, and analytics into a sustainable workflow.',
            'blocks' => [
                [
                    'type' => 'paragraph',
                    'content' => 'Welcome to 桐灼GEO 3.0. This major release unifies the admin experience and connects knowledge, AI, review, publishing, distribution, manual operations, and analytics in one GEO operations workspace.',
                ],
                [
                    'type' => 'paragraph',
                    'content' => '桐灼GEO 3.0 is guided by trust, clarity, and control. The unified interface reduces operational overhead while keeping evidence, status, risk, and next steps visible, so individuals and teams can work through the same operating loop.',
                ],
                [
                    'type' => 'heading',
                ...
                [
                    ...
                    'items' => [
                        ...
                        'Multi-site and multi-channel operations: the local site, hosted channel sites, 桐灼GEO Agent, WordPress, generic APIs, and the Chrome operations assistant',
                ...
                [
                    'type' => 'list',
                    'items' => [
                        '桐灼GEO improves content engineering efficiency and the probability that AI systems understand, cite, and recommend your content; ranking and visibility remain decisions made by each answer engine',
