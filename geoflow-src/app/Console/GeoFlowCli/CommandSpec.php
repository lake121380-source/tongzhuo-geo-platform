...
final class CommandSpec
{
    ...
    public static function all(): array
    {
        return [
            ...
            'material.knowledge-search' => self::spec('material.knowledge-search', ['material', 'search'], 3, ['query', 'limit', 'max-chars', 'expected-generation', 'allow-remote-embedding'], 'material.knowledge-search', false, 'material search KNOWLEDGE_BASE_ID --query TEXT [--limit N] [--max-chars N] [--expected-generation VALUE] [--allow-remote-embedding]'),
    ...
    {
        return [
            'ai-generated', 'allow-insecure-http', 'allow-remote-embedding', 'ansi', 'enqueue-now', 'force', 'help',
    ...
    public static function apiExamples(): iterable
    {
        $examples = [
            ...
            'material.knowledge-search' => [['material', 'search', '9', '--query', 'GEO 服务'], ['knowledgeBase' => 9]],
    ...
    public static function usage(): string
    {
        ...
        return '桐灼GEO CLI '.CliVersion::VALUE.PHP_EOL.PHP_EOL
